...
var NinjaGuru = (function(timing) {
  ...
  function renderTextStats() {
    ...
    cache.dom.display.text.httpRequests.innerHTML = '<span class="' + cache.dom.bar.prefix + '-title">http requests: </span><span class="' + cache.dom.bar.prefix + '-text">' + getNumRequests() + '</span>';
  }
  ...
  function constructUI() {
    ...
    if (enableMemoryChart) {
      ...
      span.classList.add(cache.dom.bar.prefix + '-title')
      span.innerHTML = "Mem: ";
      cache.dom.display.chart.memory.appendChild(span);
